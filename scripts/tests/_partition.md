...
- `just test-scripts-slow` — everything else. **19 suites, 388 tests, measured 1439,52s solo** (2026-08-17,
  ...
  1274,72s, 1386,48s, 1437,60s, now 1439,52s —
...
test raises it. The count today is fast **605** and slow **388**, **both measured, not added up**. It is a
...
check-ci-filter-coverage.Tests.ps1              163,9s   22 tests   <- SLOW, NEW 2026-08-17: the ci-scripts
                                                                      ...
                                                                      with the driver idle: 163 863 ms at 22
                                                                      rows (120 448 at 20, 103 065 at 13,
                                                                      78 990 at 11). At 11 rows it also measured
