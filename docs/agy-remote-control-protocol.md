...
[`clavity-classic/docs/archive/2026-06-16-agy-remote-control-design.md`](../clavity-classic/docs/archive/2026-06-16-agy-remote-control-design.md)
...
re-surface it). (See `clavity-classic/plugin/knowledge/agy-assumptions.md` → "Transient runtime gotchas".)
