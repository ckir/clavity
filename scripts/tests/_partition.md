...
agy-mark-stamp.Tests.ps1                         24,4s  10 tests    <- SLOW, NEW 2026-09-04. Task 3 (2026-09-04-phase-2-conduct-s24-s25
...
check-capstone-new-code.Tests.ps1               107,0s   31 tests   <- SLOW, NEW 2026-09-04 (ROADMAP s24 trigger). Two runs on an idle machine, 108,2s cold / 107,0s warm; background load uncontrolled.
