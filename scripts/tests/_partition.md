...
release-lib.Tests.ps1                             5,0s   21 tests   <- FAST, re-measured 2026-08-05; 23->20 on 2026-09-14 (ghidrust full retirement removed the Get-GhidrustChannel Describe); 20->21 on 2026-09-18 (Update-Changelog must emit a pure-ASCII section, so a release cannot re-break the injected-context gate)
