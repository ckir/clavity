...
test-scripts-slow:
    pwsh -NoProfile -c "Invoke-Pester @('scripts/tests/abort-drain.Tests.ps1', 'scripts/tests/accept-drain.Tests.ps1', 'scripts/tests/agy-anomaly-reminder.Tests.ps1', 'scripts/tests/agy-consult-guard.Tests.ps1', 'scripts/tests/agy-curate-nudge.Tests.ps1', 'scripts/tests/assertion-strength-reminder.Tests.ps1', 'scripts/tests/check-cheatsheet-budget.Tests.ps1', 'scripts/tests/check-curate-in-progress.Tests.ps1', 'scripts/tests/check-injected-context.Tests.ps1', 'scripts/tests/check-knowledge-store.Tests.ps1', 'scripts/tests/check-dangling-consumers.Tests.ps1', 'scripts/tests/agy-inbox-snapshot.Tests.ps1', 'scripts/tests/agy-learn-reminder.Tests.ps1', 'scripts/tests/agy-liveness-check.Tests.ps1', 'scripts/tests/agy-mark.Tests.ps1', 'scripts/tests/agy-mark-stamp.Tests.ps1', 'scripts/tests/agy-seam-inject.Tests.ps1', 'scripts/tests/agy-shield-lib.Tests.ps1', 'scripts/tests/agy-ledger-lib.Tests.ps1', 'scripts/tests/agy-test-audit-reminder.Tests.ps1', 'scripts/tests/check-cheatsheet-parity.Tests.ps1', 'scripts/tests/check-core-integrity.Tests.ps1', 'scripts/tests/check-plugin-drift.Tests.ps1', 'scripts/tests/check-plugin-namespace.Tests.ps1', 'scripts/tests/check-roadmap-claims.Tests.ps1', 'scripts/tests/compute-release.Tests.ps1', 'scripts/tests/docs-audit.Tests.ps1', 'scripts/tests/drain-knowledge.Tests.ps1', 'scripts/tests/generate-cheatsheet-literals.Tests.ps1', 'clavity-dotnet/install/clavity-install.Tests.ps1', 'scripts/tests/check-capstone-new-code.Tests.ps1', 'scripts/tests/check-peer-reply-citations.Tests.ps1', 'scripts/tests/check-installer-ascii.Tests.ps1', 'scripts/tests/installer-user-path.Tests.ps1') -Output Detailed -CI"
