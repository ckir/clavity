...
**Status:** ✅ SHIPPED — resolved umbrella-wide, not commonmemory-only.
...
- ✅ Install and uninstall against a detected Claude and agy still register/deregister correctly.
