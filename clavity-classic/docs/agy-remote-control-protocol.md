...
([`../plugin/knowledge/agy-capabilities.md`](../plugin/knowledge/agy-capabilities.md)) to decide **whether** to delegate to agy at all,
...
re-surface it). (See `../plugin/knowledge/agy-assumptions.md` → "Transient runtime gotchas".)
...
- **agy's file-write scope is config-gated (default = workspace-only).** agy's native edit tools are
  ...
  **Axis D** ([`../plugin/knowledge/agy-capabilities.md`](../plugin/knowledge/agy-capabilities.md)).
