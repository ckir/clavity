...
# steer latent breadth by naming it
...
- Steer latent breadth by NAMING it: name the DOMAIN and LENS, or the SPEC as the correctness oracle - an
  adversarial-auditor plus a named-spec pass catches spec-required null/empty/boundary cases that general
  review and property tests both miss.
