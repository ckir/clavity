...
release-lib.Tests.ps1                             5,0s   36 tests   <- FAST, re-measured 2026-08-05; 23->20 on 2026-09-14 (ghidrust full retirement removed the Get-GhidrustChannel Describe); 20->21 on 2026-09-18 (Update-Changelog must emit a pure-ASCII section, so a release cannot re-break the injected-context gate); 21->36 on 2026-09-22 (the four -Resume functions: Get-DanglingReleaseCommits, Test-ResumeState, Get-DropConflictStatus, Invoke-DropReleaseCandidate). The 5,0s time is the 2026-08-05 figure and was NOT re-measured when those 15 tests landed, so it now understates this row
