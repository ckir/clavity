...
# open framing beats closed menus for

**Section:** LOAD-BEARING ASSUMPTIONS - newly learned, additive to SEED
...
- Open framing beats closed menus for DESIGN: a closed "pick A/B/C" anchors it to your option-space; an
  OPEN "goal + verifiable criterion + full latitude" validates WITHOUT anchoring (an independent
  reproduction of your pre-baked choice is real evidence it was not framing-induced) and surfaces
  hardenings the menu never raises - most when you also ask it to name a failure mode in its OWN proposal.
