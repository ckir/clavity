...
- `just test-scripts-slow` — everything else. **19 suites, 383 tests, measured 1402,44s solo** (2026-08-17,
  ...
  1274,72s, 1386,48s, 1437,60s, 1439,52s, 1476,67s, now 1402,44s —
...
test raises it. The count today is fast **605** and slow **383**, **both measured, not added up**. It is a
...
check-ci-filter-coverage.Tests.ps1               53,9s   17 tests   <- SLOW, NEW 2026-08-17: the ci-scripts
                                                                      ...
                                                                      with the driver idle: 53 857 ms at 17 rows,
