...
> or a skill tweak, not Rust). When agy changes, re-verify the affected assumption with its listed check
> and update that entry — the manual re-verifies empirically rather than trusting a version stamp.
