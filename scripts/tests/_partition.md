...
- `just test-scripts-slow` — everything else. **19 suites, 390 tests, measured 1476,67s solo** (2026-08-17,
  ...
  1274,72s, 1386,48s, 1437,60s, 1439,52s, now 1476,67s —
...
test raises it. The count today is fast **605** and slow **390**, **both measured, not added up**. It is a
...
check-ci-filter-coverage.Tests.ps1              147,3s   24 tests   <- SLOW, NEW 2026-08-17: the ci-scripts
                                                                      ...
                                                                      with the driver idle: 147 313 ms at 24
                                                                      rows - LOWER than 163 863 ms at 22, which
                                                                      is the clearest proof in this file that
                                                                      per-row cost is not derivable (120 448 at
                                                                      20, 103 065 at 13, 78 990 at 11). At 11 rows it also measured
